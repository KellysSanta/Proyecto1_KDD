...
<script src="../static/amcharts/serial.js" type="text/javascript"></script>
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header"> Nivel de ventas por año, mes, trimestre y semestre por distribuidor</h1>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="panel-body">
          ...
          <form id="formulario">
            ...
            <input type="radio" name="tipo" value="mes" checked>Mes<br><input type="radio" name="tipo" value="anho">Año<br><input type="radio" name="tipo" value="semestre">Semestre<br><input type="radio" name="tipo" value="trimestre">Trimestre<br>
            </form>
          </div>
  ...
  <script>
    $('#calcular').click(function(){
      ...
      if(fecha_hasta>=fecha_desde){
        ...
        $.get('cfb.php', {desde:fecha_desde,hasta:fecha_hasta,tipo:$("input[name=tipo]:checked", "#formulario").val()}, function(data){
