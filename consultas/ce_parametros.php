...
<script src="../static/amcharts/serial.js" type="text/javascript"></script>
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header"> Comparativo entre ventas por Internet y los vendedores de la empresa</h1>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
  ...
  <script>
    $('#calcular').click(function(){
      ...
      if(fecha_hasta>=fecha_desde){
        $.get('ce.php', {desde:fecha_desde,hasta:fecha_hasta}, function(data){
