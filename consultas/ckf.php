...
<?php
  ...
  $query = "SELECT yearlyincome AS ingresos, count (*) AS total FROM factinternetsales, dimcustomer WHERE factinternetsales.customerkey = dimcustomer.customerkey AND duedatekey BETWEEN ".$_GET['desde']." AND ".$_GET['hasta']." GROUP BY yearlyincome";
  ...
  while ($line = pg_fetch_array($result, null, PGSQL_ASSOC)) {
      $resultado= $resultado."{'promocion': '".$line['ingresos']."', 'compras':".$line['total']."},";
  }
