...
<?php
  ...
  $query = 'SELECT salesterritorycountry AS country, SUM(totalproductcost) AS sales FROM dimsalesterritory JOIN factinternetsales ON dimsalesterritory.salesterritorykey=factinternetsales.salesterritorykey GROUP BY salesterritorycountry;';
