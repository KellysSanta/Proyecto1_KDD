...
<script src="../static/amcharts/serial.js" type="text/javascript"></script>
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header"> Comparativo del nivel de llamadas al call center en días laborales Vs días festivos</h1>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-12">
  ...
  <script>
    $('#calcular').click(function(){
      ...
      var fecha_hasta = $('#year_hasta').val()+"/"+$('#month_hasta').val()+"/"+$('#day_hasta').val();
        $.get('cn.php', {desde:fecha_desde,hasta:fecha_hasta}, function(data){
