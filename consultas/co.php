...
<?php
  ...
  $query = "SELECT shift AS franja, sum(calls) AS total FROM factcallcenter WHERE datekey BETWEEN ".$_GET['desde']." AND ".$_GET['hasta']." GROUP BY shift";
  ...
  while ($line = pg_fetch_array($result, null, PGSQL_ASSOC)) {
      $resultado= $resultado."{'promocion': '".$line['franja']."', 'compras':".$line['total']."},";
  }
