        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                  <li><a  href="#" onclick="actualizar('cq.php')" data-toggle="tooltip" data-placement="right" data-original-title="¿Cuáles con las cuentas y su departamento que más dinero mueven?"><i class=" fa fa-industry fa-fw"></i> Cuantas que di</a></li>
                </ul>
            </div>
        </div>
    </nav>
